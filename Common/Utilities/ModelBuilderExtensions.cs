...
namespace Common.Utilities
{
    public static class ModelBuilderExtensions
    {
        ...
        /// <param name="BaseType">Base type that Entities inherit from this</param>
        /// <param name="assemblies">Assemblies contains Entities</param>
        public static void RegisterAllEntitiesNoKey<BaseType>(this ModelBuilder modelBuilder, params Assembly[] assemblies)
        {
            IEnumerable<Type> types = assemblies.SelectMany(a => a.GetExportedTypes())
                .Where(c => c.IsClass && !c.IsAbstract && c.IsPublic && typeof(BaseType).IsAssignableFrom(c));
        ...
        /// <param name="baseType">Base type that Entities inherit from this</param>
        /// <param name="assemblies">Assemblies contains Entities</param>
        //public static void RegisterAllCpmlexType (this ModelBuilder modelBuilder, params Assembly[] assemblies)
        //{
        //    IEnumerable<Type> types = assemblies.SelectMany(a => a.GetExportedTypes())
        //        .Where(c => c.IsClass && !c.IsAbstract && c.IsPublic && c.HasAttribute(typeof(ComplexTypeAttribute)));

        //    foreach (Type type in types)
        //        modelBuilder.com(type);
        //}
    }
}
